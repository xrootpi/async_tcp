...
set_and_check (ASYNC-TCP_INCLUDE_DIRS "${PACKAGE_PREFIX_DIR}/include")
...
find_library(ASYNC-TCP_LIBRARY libasync-tcp.a PATHS "${PACKAGE_PREFIX_DIR}/lib" NO_DEFAULT_PATH)

set (ASYNC-TCP_LIBRARIES ${ASYNC-TCP_LIBRARY})
